from views import LiftDataCreateView, LiftDataListCreateView, LiftDataRetrieveUpdateDestroy, LiftDataSearchView, LiftHistoryListCreateView, LiftSetListCreateView
...
urlpatterns = patterns('',
    ...
    url(r'^liftdata/add/$', LiftDataCreateView.as_view()),
